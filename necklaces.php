...
$productType = isset($_GET['type']) ? $conn->real_escape_string($_GET['type']) : 'Necklace';
...
<head>
    ...
    <title>Celestial - Necklaces</title>
...
<body>
    <nav>
        ...
        <ul class="nav-middle">
            ...
            <li><a class="active" href="necklaces.php">Necklaces</a></li>
