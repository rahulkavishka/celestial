...
<head>
    ...
    <title><?php echo htmlspecialchars($name); ?> | Celestial</title>
...
<body>
    ...
    <div class="product-container">
        <div class="product_img">
            <img src="<?php echo $image_url; ?>" alt="<?php echo htmlspecialchars($name); ?>">
        </div>
        <div class="description">
            <h1><?php echo htmlspecialchars($name); ?></h1>
            <p><?php echo nl2br(htmlspecialchars($description)); ?></p>
            <h3>Price: Rs. <?php echo number_format($price, 2); ?></h3>
            ...
            <script>
                document.getElementById("addToCartBtn").addEventListener("click", function() {
                    fetch("addToCartHandler.php", {
                            ...
                            body: JSON.stringify({
                                name: "<?php echo htmlspecialchars_decode($name); ?>",
