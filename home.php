...
<body>
    ...
    <div class="container">
        <div class="heading">
            <h2>Discover Celestial Elegance</h2>
            <p>Explore our exquisite jewelry collections inspired by the cosmos. Each piece is crafted with precision,
                offering a touch of celestial magic to elevate your style.</p>
            <a href="browse.php" class="shop-now-btn">Shop Now</a>
        </div>
        <div class="firstImg"> <img src="Images/Products/SecondImg.png" alt=""> </div>
    </div>

    <div>
        <p class="cosmos">Where Beauty meets the Cosmos</p>
        <a class="discover" href="cosmicElegance.php">Discover the Collection</a>
    </div>
    ...
    <div class="container_3">
        <div class="aboutImg">
            <img src="Images/Products/AboutImg.jpg" alt="">
        </div>
        <div class="aboutContent">
            <h2>About Us</h2>
            <p>Welcome to Celestial, your trusted online jewelry marketplace. We connect customers with skilled
                merchants, offering a seamless shopping experience for buying and selling exquisite jewelry.
                <br><br>Discover high-quality, handcrafted, and designer pieces from trusted sellers all available at
                your fingertips. Whether you're searching for a timeless piece or looking to showcase your jewelry to a
                global audience, Celestial makes it easy, secure, and effortless. <br><br> Explore our collection today
                and find jewelry that tells your story!
            </p>
        </div>
    </div>
